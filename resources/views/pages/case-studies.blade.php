...
<section class="content-section">
	<div class="container">
		...
		<a data-skip-hash="true" class="anchor-link" id="results"></a>

<!--		<div class="filter-section">-->
<!--			<div class="tag-wrapper">-->
<!--				<a data-id="" href="javascript:void(0)" class="tag selected">All</a>-->
<!--				-->
<!--					<a data-id="1" href="javascript:void(0)" class="tag ">SharePoint</a>-->
<!--					-->
<!--					<a data-id="2" href="javascript:void(0)" class="tag ">Cloud</a>-->
<!--					-->
<!--					<a data-id="3" href="javascript:void(0)" class="tag ">.NET</a>-->
<!--					-->
<!--					<a data-id="4" href="javascript:void(0)" class="tag ">Mobile</a>-->
<!--					-->
<!--					<a data-id="6" href="javascript:void(0)" class="tag ">AI</a>-->
<!--					-->
<!--			</div>-->
<!--			<div class="search-form">-->
<!--				<form name="frmCaseStudiesListing" method="GET">-->
<!--					<input type="hidden" name="search" value="1"/>-->
<!--					<input type="hidden" name="page" value="1"/>-->
<!--					<input type="hidden" name="search_category" value=""/>-->

<!--					<div class="form-group">-->
<!--						<input title="Keywords" name="search_keywords" value="" type="text" placeholder="Swift, iOS, Java" class="form-control" />-->
			...
			<div class="portfolio-listing">
					...
					<div class="item">
						...
						<div class="content-block">
							...
							<h5>Machine Learning Model Training System</h5>
								...
								<div class="project-link-block mb">
									<span class="fa fa-tag"></span>
										...
										<a href="case-studiesade0.html?search=1&amp;search_keywords=AWS">AWS</a>
										
										<a href="case-studiesac69.html?search=1&amp;search_keywords=Python">Python</a>
										
										<a href="case-studiesfa13.html?search=1&amp;search_keywords=JavaScript">JavaScript</a>
										
										<a href="case-studiesc0f2.html?search=1&amp;search_keywords=React">React</a>
										
										<a href="case-studiesbd40.html?search=1&amp;search_keywords=Node%2Ejs">Node.js</a>
							...
							<a href="case-studies/machine-learning-model-training-system.html" class="more-link">Read More</a>
						</div>
						<a title="Machine Learning Model Training System" href="case-studies/machine-learning-model-training-system.html" class="area-link"></a>
					</div>
					...
					<div class="item">
						...
						<a title="Life Lines &#8212; A News Aggregation App" href="case-studies/life-lines-a-news-aggregation-app.html" class="area-link"></a>
					</div>
...
<!--			<nav class="pagination-wrap mb-big">-->
<!--				<ul class="pagination">-->
<!--					<li class="disabled">-->
<!--						<a  href="javascript:void(0)" aria-label="Previous"><span class="fa fa-angle-left"></span></a>-->
<!--					</li>-->
...
<!--					<li class="">-->
<!--						<a data-page="2" href="javascript:void(0)" aria-label="Next"><span class="fa fa-angle-right"></span></a>-->
<!--					</li>-->
<!--				</ul>-->
<!--			</nav>-->
		

		<!-- <div class="text-center mb-big"><a href="portfolio.html" class="btn btn-default btn-wide"><span>See more projects in our Portfolio</span></a></div> -->

	</div>
</section>


<script src="web/modules/casestudies/js/listing3860.js?v=1"></script>
...
<div id="quick-contact-app" class="form-wrap flex-form">
	...
	<form name="frmQuickContact" method="POST" action="case">
        @csrf
